...
$con = mysqli_connect("db:3306","dbauser","password","usuarios");
...
if($con){
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            <head>
                ...
                <title>GeekHubs alejandro project | Sesion</title>
            ...
            <body>
                ...
                <footer>
                    <div class="conteninfo">
                        <h1>GeekHubs Academy</h1>
                        <p>Página diseñada por Alejandro Molina. | Proposito de prueba de concepto</p>
    ...
    echo "Problema de conexion a mysqli";
}
